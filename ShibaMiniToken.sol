...
contract FeeFund is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10**18;        // total supply : 5000
    ...
    function setBufferContract(address _buffer) external onlyOwner {
    ...
    function _takeExtra(uint256 tExtra) private {
        ...
        _rOwned[buffContract] = _rOwned[buffContract].add(rExtra);
        if(_isExcluded[buffContract])
            _tOwned[buffContract] = _tOwned[buffContract].add(tExtra);
    }
