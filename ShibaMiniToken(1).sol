...
contract ShibaMini is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**18;        // total supply : 5000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ShibaMini";
    string private _symbol = "πShib";
    ...
    uint256 public _liquidityFee = 5;          // 2% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _extraFee = 1;            // team 
    ...
    uint256 public _maxTxAmount = 100000000 * 10**18;          // anti-whale : 0.05 per transaction
    ...
    function _takeExtra(uint256 tExtra) private {
        ...
        _rOwned[teamWallet] = _rOwned[teamWallet].add(rExtra);
        if(_isExcluded[teamWallet])
            _tOwned[teamWallet] = _tOwned[teamWallet].add(tExtra);
    }
